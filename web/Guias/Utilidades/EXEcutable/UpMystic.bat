...
IF NOT EXIST "%USERPROFILE%\mystic" (
    ...
    git clone https://chat.whatsapp.com/LyMfzukGtcO7lw87VFIxBV.git "%USERPROFILE%\mystic"
...
git pull https://chat.whatsapp.com/LyMfzukGtcO7lw87VFIxBV.git > git_output.txt
