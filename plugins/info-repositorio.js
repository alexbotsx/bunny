...
const handler = async (m, { conn, args, usedPrefix }) => {
   ...
   const res = await fetch('https://api.github.com/repos/BrunoSobrino/𝑩𝑶𝑻 • 𝑲𝑨𝑻𝑻𝑬');
   ...
   txt += `${tradutor.texto1[11]}\n_${usedPrefix}gitclone ${json?.html_url || 'https://chat.whatsapp.com/LyMfzukGtcO7lw87VFIxBV'}_`;
