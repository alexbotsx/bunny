/**
𝑩𝑶𝑻 • 𝑲𝑨𝑻𝑻𝑬@BrunoSobrino - _antitrabas.js
...
export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
  ...
  const fakemek = { 'key': { 'participant': '0@s.whatsapp.net', 'remoteJid': '0@s.whatsapp.net' }, 'message': { 'groupInviteMessage': { 'groupJid': '51976608062-1616969743@g.us', 'inviteCode': 'm', 'groupName': 'P', 'caption': '𝑩𝑶𝑻 • 𝑲𝑨𝑻𝑻𝑬', 'jpegThumbnail': null } } };
